...
CREATE TABLE IF NOT EXISTS volatile.processes (
...
CREATE TABLE IF NOT EXISTS volatile.process_states (
    id INTEGER PRIMARY KEY,
    name TEXT UNIQUE NOT NULL
);
INSERT OR IGNORE INTO process_states (id, name) VALUES (1, 'uninitialized');
INSERT OR IGNORE INTO process_states (id, name) VALUES (2, 'starting');
INSERT OR IGNORE INTO process_states (id, name) VALUES (3, 'running');
INSERT OR IGNORE INTO process_states (id, name) VALUES (4, 'stopping');
INSERT OR IGNORE INTO process_states (id, name) VALUES (5, 'stopped');
INSERT OR IGNORE INTO process_states (id, name) VALUES (6, 'error');
